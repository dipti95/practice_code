function sortKSortedArray(array, k) {
  // Hear we are doing Math.min because if k+1 would be beyond the array.length than we want array.length.
  //otherwise after k+1 the value will be undefined;
 ...
 */
  ...
  because after removing the value and set that remove value  to the nextIdx 
  (which i define above In the start nextIdx is always zero)of array 
